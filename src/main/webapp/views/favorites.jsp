		...
		<div class="container">
			<div class="row">
				<ul>
					...
					<li><i class="fas fa-angle-double-right"></i> My Favorites</li>
				</ul>
			</div>
		</div>
	</div>
	<!--####################### Trending Starts Here ###################-->
	<div class="treanding-video container-fluid" style="margin-bottom: 450px">
		<div class="container">
			<div class="row video-title no-margin">
				<h6>
					<i class="fas fa-book"></i> Video yêu thích
				</h6>
			</div>
